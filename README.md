...
This repository implements the research pipeline for the **BREAKTHROUGH 43: Mirror Neuron Disruption from Screen Addiction** project, developed by the Runtime-Slayers research group.
...
The project directory consists of the following core structures:
  ...
  - `BT43_Mirror_Neuron_Screen_Addiction.md`
  - `real_data_tests`
...
1. Clone this repository:
   ```bash
   git clone https://github.com/Runtime-Slayers/Graph-Neural-Networks-for-Student-Dropout-Prediction-in-Adaptive-Learning.git
   cd Graph-Neural-Networks-for-Student-Dropout-Prediction-in-Adaptive-Learning
   ```
